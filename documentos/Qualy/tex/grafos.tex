...
Como essa dissertação utilizará mapas topológicos para definir a trajetória do robôs e grafos para determinar a seqüência de salas a visitar. Grafos e mapas topológicos, são muito utilizados na literatura para navegação de robôs móveis, como podemos ver em \cite{Adorno2005} \cite{Scatena2004} \cite{Thrun1996} \cite{Thrun1998} \cite{Thrun1998a} \cite{Neto2003}. Como o problema proposto (seção \ref{proposta}) diz respeito à busca de trajetória em um mapa topológico (grafo) ele se torna uma variação do problema do caixeiro viajante que trata, basicamente de encontrar o menor ciclo hamiltoniano em um grafo.
