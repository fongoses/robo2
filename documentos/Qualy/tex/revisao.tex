...
\begin{itemize}
	\item Passo 1: Iniciar os valores:
			para todo $v \leftarrow V[G]$
d[v]¿ ¿
¿[v] ¿ nulo
		d[s] ¿ 0
		V[G] é o conjunto de vértices v que forma o grafo G.
		d[v] é o vetor de distâncias do vértice s até cada vértice v.
		¿[v] identifica o vértice de onde se origina uma conexão até v de maneira a formar um caminho mínimo.
		Passo 2: Temos que usar dois conjuntos: S, que representa todos os vértices v onde d[v] já contém o custo do menor caminho e Q que contém os vértices restantes.
		Passo 3: Realizamos uma série de relaxamentos das arestas:
		Enquanto Q ¿ ø
		u ¿ extraia-mín(Q)
		S ¿ S U {u}
		...
		extraia-mín(Q), retorna o menor elemento.
