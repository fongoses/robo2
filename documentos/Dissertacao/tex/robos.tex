...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.60\textwidth]{../../imagens/grafico_potencia_por_velocidade.png}
	\caption{Potência por velocidade de vários mecanismos de locomoção: (a) Rastejar e deslizar. (b) Correr. (c) Pneu em chão suave. (d) Andar. (e) Em ferrovia. (1) Unidade de potência (Cavalos/toneladas). (2) Velocidade (milhas/hora)\cite{Siegwart2004}.}
	\label{fig:potencia_por_velocidade}
\end{figure}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.60\textwidth]{../../imagens/tipos_de_roda.png}
	\caption{Quatro tipos básicos de roda. (a) Roda padrão. (b) Roda castor. (c) Roda sueca. (d) Bola ou roda esférica\cite{Siegwart2004}.}
	\label{fig:tipos_de_rodas}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Exemplo de Funcionamento do LASER \cite{Baguinski2010}.}
	\label{fig:laser}
\end{figure}
...
O servidor Player foi desenvolvido para que seus clientes sejam independentes de linguagem e de plataforma. O programa cliente pode ser executado em qualquer máquina que tenha conexão de rede com o robô, e pode ser escrito em qualquer linguagem que suporte sockets TCP. Atualmente existem clientes disponíveis em C++, Tcl, Java e Phyton \cite{Player2010}. O Player é indiferente sobre como o programa de controle do robô é estruturado, ou seja, pode-se escrever desde programas \textit{multi-threads} altamente concorrentes até programas seqüencias simples.
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.90\textwidth]{../../imagens/player1.png}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.90\textwidth]{../../imagens/player2.png}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.90\textwidth]{../../imagens/modelo_cliente_servidor.png}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.90\textwidth]{../../imagens/abstracao_de_hardware.png}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.90\textwidth]{../../imagens/exemplo_cliente_servidor.png}
