...
Para os testes foram criados sete mapas, como mostra a Figura \ref{fig:mapas_testes}:
\begin{itemize}
	\item Quatro: Com quatro salas de prioridades iguais e ligação entre todas as salas (Figura \ref{fig:mapa_quatro});
	\item Quatro Diff: Com quatro salas com prioridades diferentes e ligação entre todas as salas (Figura \ref{fig:mapa_quatro});
	\item X: Com cinco salas em que formam um X com ligações entre as salas das pontas (Figura \ref{fig:mapa_x});
	\item X Incompleto: Com cinco salas em formato de X com somente a sala do meio ligando as outras (Figura \ref{fig:mapa_x_incompleto});
	\item Espinha: Com seis salas em formato de espinha de peixe com prioridades iguais (Figura \ref{fig:mapa_espinha});
	\item Espinha Diff: Com seis salas em formato de espinha de peixa com prioridades diferentes (Figura \ref{fig:mapa_espinha}) e
	\item Apartamento: Com oito salas simulando um apartamento real(Figura \ref{fig:mapa_ap}).
\end{itemize}

\begin{figure}[ht]
  \centering
	\subfigure[Quatro]{
    \includegraphics[width=0.177\textwidth]{../../imagens/mapa_quatro.png}
		\label{fig:mapa_quatro}}	
	\subfigure[X]{
    \includegraphics[width=0.234\textwidth]{../../imagens/mapa_x.png}
		\label{fig:mapa_x}}	
	\subfigure[X incompleto]{
    \includegraphics[width=0.234\textwidth]{../../imagens/mapa_x_incompleto.png}
		\label{fig:mapa_x_incompleto}}	
	\subfigure[Espinha]{
    \includegraphics[width=0.253\textwidth]{../../imagens/mapa_espinha.png}
		\label{fig:mapa_espinha}}	
	\subfigure[Apartamento]{
    \includegraphics[width=1\textwidth]{../../imagens/mapa_ap.png}
		\label{fig:mapa_ap}}	
	\caption{Mapas para testes.}
	\label{fig:mapas_testes}
\end{figure}


A Tabela \ref{tab:prioridades_testes} mostra as prioridades utilizadas nos testes.
\begin{table}
\caption{Prioridades das salas nos mapas.}
\centering
\subtable[Quatro]{
      \begin{tabular}
      {|c|c|}
