...
O gráfico (Figura \ref{fig:grafico_quatro}) mostra que a solução em Tempo Real depois de estabilizar teve um desempenho inferior à solução \texttt{Offline}.
\begin{figure}[htb]
	\centering
...
Como o Mapa Quatro é pequeno (dois metros quadrados) e a seqüência gerada pela solução \texttt{Offline} é visitar as salas no sentido anti-horário, o robô leva exatamente o mesmo tempo para ir de uma sala à outra. E como as prioridades são todas iguais e para gerar o gráfico foram tiradas medidas (Grau de Urgência Total) de dez em dez segundos, coincidiu de o robô a cada dez segundos estar no mesmo lugar no mapa, por isso o gráfico do Mapa Quatro para a solução \texttt{Offline} é uma linha. Fato que não acontece no gráfico do Mapa Quatro Diff (Figura \ref{fig:grafico_quatro_diff}) pois as prioridades não são todas iguais.
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_quatro_diff}. Sendo a sala 4 com a maior diferença, 0,012 que equivale a 2,88\%.
...
\end{table}
	...
	O gráfico do Mapa Quatro Diff (Figura \ref{fig:grafico_quatro_diff}), diferentemente do gráfico do Mapa Quatro (Figura \ref{fig:grafico_quatro}), ilustra que a solução \texttt{Offline} manteve o Grau de Urgência Total dentro de uma faixa, entre dez e trinta aproximadamente, mas seu desempenho também foi superior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/quatro_diff.png}
	\caption{Gráfico do Mapa .}
	\label{fig:grafico_quatro_diff}
\end{figure}


\item X: Com cinco salas em que formam um X (Prioridades na Tabela \ref{tab:P_x}) com ligações entre as salas das pontas (Figura \ref{fig:mapa_x});
	
\begin{figure}[hb]
  \centering
  \subfigure[Grafo do Mapa X.]{\label{fig:grafo_x}\includegraphics[width=0.2\textwidth]{../../imagens/mapa_x.png}}                
  \qquad
  \subtable[Prioridades do mapa X.]{
  	\begin{tabular}{|c|c|}
  		\hline
			Sala & Prioridade \\
			\hline
	...
	\qquad
  \subfigure[Gráfico do Mapa X.]{\label{fig:grafico_x}\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/x.png}}
  \caption{Mapa X.}
  \label{fig:mapa_x}
\end{figure}

%\newpage
	\item X Incompleto: Com cinco salas em formato de X (Prioridades na Tabela \ref{tab:P_x}) com somente a sala do meio ligando as outras (Figura \ref{fig:mapa_x_incompleto});
	
\begin{figure}[hb]
  \centering
  \subfigure[Grafo do Mapa X Incompleto.]{\label{fig:grafo_x}\includegraphics[width=0.2\textwidth]{../../imagens/mapa_x_incompleto.png}}                
	\qquad
  \subfigure[Gráfico do Mapa X Incompleto]{\label{fig:grafico_x_incompleto}\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/x_incompleto.png}}
  \caption{Mapa X Incompleto}
  \label{fig:mapa_x_incompleto}
\end{figure}

	\item Espinha: Com seis salas de prioridades iguais (Tabela \ref{tab:P_espinha}) em formato de espinha de peixe (Figura \ref{fig:mapa_espinha});

\begin{figure}[hb]
  \centering
  \subfigure[Grafo do Mapa Espinha.]{\label{fig:grafo_espinha}\includegraphics[width=0.2\textwidth]{../../imagens/mapa_espinha.png}}                
  \qquad
  \subtable[Prioridades do Mapa Espinha.]{
  	\begin{tabular}{|c|c|}
  		\hline
			Sala & Prioridade \\
			\hline
	...
	\qquad
  \subfigure[Gráfico do Mapa Espinha.]{\label{fig:grafico_espinha}\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/espinha.png}}
  \caption{Mapa Espinha.}
  \label{fig:mapa_espinha}
\end{figure}
	
	\item Espinha Diff: Com seis salas de prioridades diferentes (Tabela \ref{tab:P_espinha}) em formato de espinha de peixe (Figura \ref{fig:mapa_espinha}) e
\begin{figure}[hb]
  \centering
  \subtable[Prioridades do Mapa Espinha Diff.]{
  	\begin{tabular}{|c|c|}
  		\hline
			Sala & Prioridade \\
			\hline
	...
	\qquad
  \subfigure[Gráfico do Mapa Espinha Diff.]{\label{fig:grafico_espinha_diff}\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/espinha_diff.png}}
  \caption{Mapa Espinha Diff.}
  \label{fig:mapa_espinha_diff}
\end{figure}
	
	\item Apartamento: Com oito salas de prioridades diferentes (Tabela \ref{tab:P_ap}) simulando um apartamento real (Figura \ref{fig:mapa_ap}).

\begin{figure}[hb]
  \centering
  \subfigure[Grafo do Mapa Apartamento.]{\label{fig:grafo_ap}\includegraphics[width=0.6\textwidth]{../../imagens/mapa_ap.png}}                
  \qquad
  \subtable[Prioridades do Mapa Apartamento.]{
  	\begin{tabular}{|c|c|}
  		\hline
			Sala & Prioridade \\
			\hline
	...
	\qquad
  \subfigure[Gráfico do Mapa Apartamento.]{\label{fig:grafico_ap}\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/ap.png}}
  \caption{Mapa Apartamento.}
  \label{fig:mapa_espinha_diff}
\end{figure}

\end{itemize}

O \texttt{gerador} gerou as seqüências de salas para serem visitadas descritas da Tabela \ref{tab:sequencias}.

\begin{table}\begin{center}
\caption{Seqüências de salas a ser visitadas geradas pelo \texttt{gerador}}
	\begin{tabular}
		{|c|c|}
		\hline
		Mapa & Seqüência \\
		\hline
		Quatro Diff& 1 3 4 2 4 3\\
		X & 1 2 4 5 3 2 4 5 3\\
		X Incompleto& 1 2 3 4 5\\
		Espinha & 1 5 2 6 3 7\\
		Espinha Diff& 1 2 6 5 1 7 3 5\\
		Apartamento& 1 12 9 11 5 7 3 4\\
		\hline
	\end{tabular}
\end{center}
...
\begin{figure}[ht]
  \centering
	\subfigure[Quatro]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/quatro.png}
		\label{fig:grafico_quatro}}	
	\subfigure[Quatro Diff]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/quatro_diff.png}
		\label{fig:grafico_quatro_diff}}	
	\subfigure[X]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/x.png}
		\label{fig:grafico_x}}	
	\subfigure[X Incompleto]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/x_incompleto.png}
		\label{fig:grafico_x_incompleto}}	
	\subfigure[Espinha]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/espinha.png}
		\label{fig:grafico_espinha}}	
	\subfigure[Espinha Diff]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/espinha_diff.png}
		\label{fig:grafico_espinha_diff}}	
	\subfigure[Apartamento]{
    \includegraphics[width=0.35\textwidth]{../../../resultados/graficos/ap.png}
		\label{fig:grafico_ap}}	
	\label{fig:graficos}	
	\caption{Gráficos dos restultados.}
\end{figure}
