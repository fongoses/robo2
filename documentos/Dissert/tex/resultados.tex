...
\begin{figure}[!hb]
	\centering
		\includegraphics[width=0.95\textwidth]{../../../resultados/graficos/quatro.png}
...
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.3\textwidth]{../../imagens/mapa_x.png}
	\caption{Grafo do Mapa C.}
	\label{fig:grafo_x}
\end{figure}
\begin{table}[hb]
	\centering
	\caption{Prioridades do Mapa C.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
