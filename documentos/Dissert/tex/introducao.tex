...
A comunidade científica aposta que sistemas robóticos estejam cada vez mais presentes em nossa vida cotidiana, o que torna esta área de pesquisa extremamente promissora e desafiadora. Segundo Bill Gates \cite{Gates2007}, a humanidade está entrando numa nova era da computação, comparando os robôs industriais com os \textit{mainframes} de antigamente, e este autor prevê que existirá um robô em cada casa no futuro.
...
A robótica móvel, além de ser uma área de grande potencial científico, tem atraído a atenção de empresas de tecnologia que cada vez mais investem no desenvolvimento de produtos; como por exemplo os robôs que realizam trabalhos domésticos autonomamente,  entre os quais o aspirador de pó Roomba da IRobot \cite{IRobot} (Figura \ref{fig:roomba}) e o robô cortador de grama Robomow (Figura \ref{fig:robomow}) da Friendly Robotics \cite{FriendlyRobotics}. Ambos apresentam sucesso comercial. 
...
\section{Objetivos}
\label{objetivos}
A proposta desta dissertação é desenvolver soluções de robótica móvel para o monitoramento de ambientes internos, onde normalmente, nesses ambientes, existem regiões críticas para serem monitoradas, cada qual com sua prioridade. A prioridade (urgência) da visita de cada uma dessas regiões aumenta conforme o tempo passa e essa região não é visitada. Ao ser visitada, a urgência de uma determinada região é, então, zerada. 
