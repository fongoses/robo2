...
A robótica móvel, além de ser uma área de grande potencial científico, tem atraído a atenção de empresas de tecnologia que cada vez mais investem no desenvolvimento de produtos; como por exemplo os robôs que realizam trabalhos domésticos autonomamente,  entre os quais o robô aspirador de pó e o robô cortador de grama.
...
Mapa A: Com quatro salas de prioridades iguais (Tabela \ref{tab:P_quatro}) e ligação entre todas as salas (Figura \ref{fig:grafo_quatro}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.1\textwidth]{../../imagens/mapa_quatro.jpg}
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/quatro.png}
...
Mapa B: Com quatro salas com prioridades diferentes (Tabela \ref{tab:P_quatro_diff}) e ligação entre todas as salas (Figura \ref{fig:grafo_quatro}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/quatro_diff.png}
	\caption{Gráfico do Mapa B.}
	\label{fig:grafico_quatro_diff}
\end{figure}


Mapa C: Com cinco salas que formam um X (Prioridades na Tabela \ref{tab:P_x}) com ligações entre as salas das pontas (Figura \ref{fig:grafo_x}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.13\textwidth]{../../imagens/mapa_x.jpg}
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/x.png}
...
Mapa D: Com cinco salas em formato de X (Prioridades iguais ao mapa anterior indicados na Tabela \ref{tab:P_x}) com somente a sala do meio ligando as outras (Figura \ref{fig:grafo_x_incompleto}):
	
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.13\textwidth]{../../imagens/mapa_x_incompleto.jpg}
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/x_incompleto.png}
	\caption{Gráfico do Mapa D.}
	\label{fig:grafico_x_incompleto}
\end{figure}


Mapa E: Com seis salas de prioridades iguais (Tabela \ref{tab:P_espinha}) em formato de espinha de peixe (Figura \ref{fig:grafo_espinha}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.13\textwidth]{../../imagens/mapa_espinha.jpg}
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/espinha.png}
	\caption{Gráfico do Mapa E.}
	\label{fig:grafico_espinha}
\end{figure}


Mapa F: Com seis salas de prioridades diferentes (Tabela \ref{tab:P_espinha_diff}) em formato de espinha de peixe (Figura \ref{fig:grafo_espinha}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.45\textwidth]{../../../resultados/graficos/espinha_diff.png}
	\caption{Gráfico do Mapa F.}
	\label{fig:grafico_espinha_diff}
\end{figure}
	
Mapa G: Com oito salas de prioridades diferentes (Tabela \ref{tab:P_ap}) simulando um apartamento real (Figura \ref{fig:grafo_ap}):
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.4\textwidth]{../../imagens/mapa_ap.jpg}
...
\begin{figure}[!hbt]
	\centering
		\includegraphics[width=0.4\textwidth]{../../imagens/tendencia.png}
