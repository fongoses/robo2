...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_quatro}.

\begin{table}[hb]
	\centering
	\caption{Prioridades proporcionais do Mapa Quatro.}
	\begin{tabular}{|c|c|c|}
		\hline
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_quatro_diff}.

\begin{table}[hb]
	\centering
	\caption{Prioridades proporcionais do Mapa Quatro Diff.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_x}.

\begin{table}[!h]
	\centering
	\caption{Prioridades proporcionais do Mapa X.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_x_incompleto}.

\begin{table}[htb]
	\centering
	\caption{Prioridades proporcionais do Mapa X Incompleto.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_espinha}.

\begin{table}[!h]
	\centering
	\caption{Prioridades proporcionais do Mapa Espinha.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
\end{figure}
	...
	\item Espinha Diff: Com seis salas de prioridades diferentes (Tabela \ref{tab:P_espinha_diff}) em formato de espinha de peixe (Figura \ref{fig:grafo_espinha}) e
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_espinha_diff}.

\begin{table}[htb]
	\centering
	\caption{Prioridades proporcionais do Mapa Espinha Diff.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
As prioridades proporcionais finais da solução em Tempo Real foram próximas às prioridades proporcionais inicias, como mostra a Tabela \ref{tab:Pp_ap}.

\begin{table}[htb]
	\centering
	\caption{Prioridades proporcionais do Mapa Apartamento.}
	\begin{tabular}{|c|c|c|}
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
Analisando as prioridades proporcionais geradas pela solução em Tempo Real pode se concluir que a mesma foi capaz de alcançar as prioridades definidas de cada mapa em tempo de execução.

Em todos os testes viu-se a solução \textit{Offline} foi mais eficiente que a solução em Tempo Real. 
