...
A solução em tempo real inicia as prioridades de todas as salas em zero, cada sala recebe um valor correspondente à chance dessa sala gerar uma emergência, como uma lixeira cheia por exemplo. A cada emergência gerada a prioridade da sala é acrescida de uma unidade. O robô segue o paradigma de ir à sala de maior grau de urgência, visita a sala e procura a próxima sala de maior grau de urgência.
...
Para os testes foram criados sete mapas, cada qual com uma peculiaridade diferente:
\begin{itemize}
	\item Quatro: Com quatro salas de prioridades iguais (Tabela \ref{tab:P_quatro}) e ligação entre todas as salas (Figura \ref{fig:grafo_quatro}):

\begin{figure}[htb]
	\centering
		\includegraphics[width=0.2\textwidth]{../../imagens/mapa_quatro.png}
	\caption{Grafo do Mapa Quatro.}
	\label{fig:grafo_quatro}
\end{figure}

\begin{table}[hb]
	\centering
	\caption{Prioridades do Mapa Quatro.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_quatro}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa Quatro.}	
	\begin{tabular}{|c|c|c|}	
		\hline
...
A Tabela \ref{tab:Fr_quatro} mostra que as freqüências relativas tanto da solução \textit{Offline} quanto a em Tempo Real foram próximas às prioridades relativas. A tabela mostra também que a solução \textit{Offline} foi melhor que a solução em Tempo Real.
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa Quatro.}	
	\label{tab:Fr_quatro}	
\end{table}			
...
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/quatro.png}
	\caption{Gráfico do Mapa Quatro.}
	\label{fig:grafico_quatro}
\end{figure}
%

Como o Mapa Quatro é pequeno (dois metros quadrados) e a seqüência gerada pela solução \textit{Offline} é visitar as salas no sentido anti-horário, o robô leva exatamente o mesmo tempo para ir de uma sala à outra. E como as prioridades são todas iguais e para gerar o gráfico foram tiradas medidas (Grau de Urgência Total) de dez em dez segundos, coincidiu de o robô a cada dez segundos estar no mesmo lugar no mapa, por isso o gráfico do Mapa Quatro para a solução \textit{Offline} é uma linha. Fato que não acontece no gráfico do Mapa Quatro Diff (Figura \ref{fig:grafico_quatro_diff}) pois as prioridades não são todas iguais.
 
	\item Quatro Diff: Com quatro salas com prioridades diferentes (Tabela \ref{tab:P_quatro_diff}) e ligação entre todas as salas (Figura \ref{fig:grafo_quatro}):
	
\begin{table}[hb]
	\centering
	\caption{Prioridades do Mapa Quatro Diff.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_quatro_diff}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa Quatro Diff.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
A Tabela \ref{tab:Fr_quatro_diff} mostra as freqüências relativas das soluções \textit{Offline} e em Tempo Real. Nota-se que as freqüências relativas das salas 1 e 2 da solução \textit{Offline} são aproximadamente o dobro das suas respectivas prioridades relativas, porém, em números, é uma diferença de aproximadamente 0,08. E as freqüências relativas da solução em Tempo Real são próximas às suas respectivas prioridades relativas. A tabela mostra também que a solução em Tempo Real foi melhor que a solução \textit{Offline}.
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa Quatro Diff.}	
	\label{tab:Fr_quatro_diff}	
\end{table}		

O gráfico do Mapa Quatro Diff (Figura \ref{fig:grafico_quatro_diff}), diferentemente do gráfico do Mapa Quatro (Figura \ref{fig:grafico_quatro}), ilustra que a solução \textit{Offline} manteve o Grau de Urgência Total dentro de uma faixa, entre dez e trinta aproximadamente, mas seu desempenho também foi superior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/quatro_diff.png}
	\caption{Gráfico do Mapa Quatro Diff.}
	\label{fig:grafico_quatro_diff}
\end{figure}


\item X: Com cinco salas em que formam um X (Prioridades na Tabela \ref{tab:P_x}) com ligações entre as salas das pontas (Figura \ref{fig:grafo_x}):
	
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.2\textwidth]{../../imagens/mapa_x.png}
	\caption{Grafo do Mapa X.}
	\label{fig:grafo_x}
\end{figure}
\begin{table}[hb]
	\centering
	\caption{Prioridades do Mapa X.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_x}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa X.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
A freqüência relativa da sala 1 na solução \textit{Offline} foi maior que o dobro da sua prioridade relativa, entretanto, a diferença numérica é aproximadamente 0,06. As freqüências relativas das salas restantes da solução \textit{Offline} e as freqüências relativas de todas as salas da solução em Tempo Real foram próximas às prioridades relativas, como mostra a Tabela \ref{tab:Fr_x}. A tabela mostra também que a solução Tempo Real foi melhor que a solução \textit{Offline}.
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
\end{tabular}	
	\caption{Freqüências Relativas do Mapa X.}	
	\label{tab:Fr_x}	
\end{table}		

O gráfico (Figura \ref{fig:grafico_x}) mostra que a solução \textit{Offline} depois de estabilizar teve um desempenho inferior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/x.png}
	\caption{Gráfico do Mapa X.}
	\label{fig:grafico_x}
\end{figure}

	\item X Incompleto: Com cinco salas em formato de X (Prioridades iguais ao mapa anterior indicados na Tabela \ref{tab:P_x}) com somente a sala do meio ligando as outras (Figura \ref{fig:grafo_x_incompleto}):
	
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.2\textwidth]{../../imagens/mapa_x_incompleto.png}
	\caption{Grafo do Mapa X Incompleto.}
	\label{fig:grafo_x_incompleto}
\end{figure}

A seqüência de salas a serem visitadas gerada pelo \texttt{gerador} foi: 1 2 3 4 5.

As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_x_incompleto}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa X Incompleto.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa X Incompleto.}	
	\label{tab:Fr_x_incompleto}	
\end{table}		

O gráfico (Figura \ref{fig:grafico_x_incompleto}) mostra que a solução \textit{Offline} depois de estabilizar teve um desempenho inferior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/x_incompleto.png}
	\caption{Gráfico do Mapa X Incompleto.}
	\label{fig:grafico_x_incompleto}
\end{figure}


	\item Espinha: Com seis salas de prioridades iguais (Tabela \ref{tab:P_espinha}) em formato de espinha de peixe (Figura \ref{fig:grafo_espinha}):

\begin{figure}[htb]
	\centering
		\includegraphics[width=0.2\textwidth]{../../imagens/mapa_espinha.png}
	\caption{Grafo do Mapa .}
	\label{fig:grafo_espinha}
\end{figure}

\begin{table}[!ht]
	\centering
	\caption{Prioridades do Mapa Espinha.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_espinha}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa Espinha.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
A Tabela \ref{tab:Fr_espinha} mostra que as freqüências relativas tanto da solução \textit{Offline} quanto a em Tempo Real foram próximas às prioridades relativas.	A tabela mostra também que a solução \textit{Offline} foi melhor que a solução Tempo Real.	
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa Espinha.}	
	\label{tab:Fr_espinha}	
\end{table}		

O gráfico (Figura \ref{fig:grafico_espinha}) mostra que a solução \textit{Offline} depois de estabilizar teve um desempenho inferior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/espinha.png}
	\caption{Gráfico do Mapa Espinha.}
	\label{fig:grafico_espinha}
\end{figure}

	\item Espinha Diff: Com seis salas de prioridades diferentes (Tabela \ref{tab:P_espinha_diff}) em formato de espinha de peixe (Figura \ref{fig:grafo_espinha}):

\begin{table}[htb]
	\centering
	\caption{Prioridades do Mapa Espinha Diff.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_espinha_diff}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa Espinha Diff.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
A Tabela \ref{tab:Fr_espinha_diff} mostra que as freqüências relativas da solução \textit{Offline} foram diferentes das prioridades relativas, visitando as salas 1 e 5 o dobro de vezes que as demais salas, pois na seqüência determinada pelo \texttt{gerador} as salas 1 e 5 aparecem duas vezes cada uma. Todavia as freqüências relativas da solução em Tempo Real foram próximas às prioridades relativas. A tabela mostra também que a solução Tempo Real foi melhor que a solução \textit{Offline}.
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa Espinha Diff.}	
	\label{tab:Fr_espinha_diff}	
\end{table}		
O gráfico (Figura \ref{fig:grafico_espinha_diff}) mostra que a solução \textit{Offline} depois de estabilizar teve um desempenho inferior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/espinha_diff.png}
	\caption{Gráfico do Mapa Espinha Diff.}
	\label{fig:grafico_espinha_diff}
\end{figure}
	
	\item Apartamento: Com oito salas de prioridades diferentes (Tabela \ref{tab:P_ap}) simulando um apartamento real (Figura \ref{fig:grafo_ap}):

\begin{figure}[!ht]
	\centering
		\includegraphics[width=0.8\textwidth]{../../imagens/mapa_ap.png}
	\caption{Grafo do Mapa Apartamento.}
	\label{fig:grafo_ap}
\end{figure}
...
\begin{table}[htb]
	\centering
	\caption{Prioridades do Mapa Apartamento.}
 	\begin{tabular}{|c|c|c|}
		\hline
		Sala & Prioridade\\
		\hline
...
As prioridades relativas finais da solução em Tempo Real foram próximas às prioridades relativas inicias, como mostra a Tabela \ref{tab:Pr_ap}.		
 		
\begin{table}[hb]		
	\centering	
	\caption{Prioridades relativas do Mapa Apartamento.}	
	\begin{tabular}{|c|c|c|}	
		\hline
		Sala & \textit{Offline} & Tempo Real \\
		\hline
...
A Tabela \ref{tab:Fr_ap} mostra que as freqüências relativas tanto da solução \textit{Offline} foram aproximadamente todas iguais, isso se deve ao fato de que a seqüência de salas a serem visitadas gerada pelo \texttt{gerador} manda o robô visitar cada sala apenas uma única vez dentro do \textit{loop}, porém as maiores diferenças numéricas são as das sala 3 e 4 que são aproximadamente 0,03. Na mesma tabela pode-se ver também que as prioridades relativas da solução em Tempo Real foram próximas às prioridades relativas.	A tabela mostra também que a solução Tempo Real foi melhor que a solução \textit{Offline}.
...
\begin{table}		
	...
	\begin{tabular}{cc|c|c|c|c|}	
		...
		\hline
	\end{tabular}	
	\caption{Freqüências Relativas do Mapa Apartamento.}	
	\label{tab:Fr_ap}	
\end{table}		

O gráfico (Figura \ref{fig:grafico_ap}) mostra que a solução \textit{Offline} depois de estabilizar teve um desempenho inferior à solução em Tempo Real.
\begin{figure}[htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../../resultados/graficos/ap.png}
	\caption{Gráfico do Mapa Apartamento.}
	\label{fig:grafico_ap}
\end{figure}

Foi calculado uma média de cada solução em cada mapa com os últimos Dez mil segundos (Tabela \ref{tab:media_final}), analisando essa média nota-se que existe uma tendência de que quanto maior o número de salas mais eficiente será a solução \textit{Offline} em relação à solução em Tempo Real, como mostra o gráfico na Figura \ref{fig:grafico_tendencia}.
\begin{table}[!ht]
	\centering
		\begin{tabular}{|c|c|c|}
			\hline			
			...
			\hline
			Quatro (4) 			& 25,000 & 28,150 \\
			Quatro Diff (4) & 20,980 & 28,346 \\
			X (5) 					& 28,905 & 38,753 \\
			X Incompleto (5)& 39,719 & 50,326 \\
			Espinha (6)			& 58,527 & 72.622 \\
			Espinha Diff (6)& 55,557 & 66,711 \\
			Apartamento (8)	& 73,318 &100,217 \\
			\hline			
		\end{tabular}
...
\begin{itemize}
	\item Segundo o critério de avaliação de freqüência relativa a solução em Tempo Real foi superior à solução \textit{Offline}, pois for mais eficiente em cinco dos sete testes e na soma total das diferenças quadráticas (0,10812 da solução \textit{Offline} contra 0,00652 da solução em Tempo Real);
	\item Segundo o critério de avaliação de Grau de Urgência Total a solução \textit{Offline} foi melhor em todos os testes realizados.
\end{itemize}

Era esperado que a solução \textit{Offline} tivesse um desempenho pior que a solução em Tempo Real no critério de avaliação de freqüência relativa, pois a avaliação das seqüências de salas à visitar é baseada somente no Grau de Urgência Total. E o desempenho das soluções segundo o critério de avaliação de Grau de Urgência Total mostra que o robô seguindo uma heurística simples tem um desempenho inferior do que uma solução que determina a seqüência de salas a serem visitadas antes de colocar o robô no ambiente.

Por fim, o que determina qual solução deve ser utilizada depende da aplicação. Se para a aplicação a freqüência relativa for mais importante do que manter o Grau de Urgência baixo, deve-se escolher a solução em Tempo Real, porém se para a aplicação for mais importante manter o Grau de Urgência baixo deve-se escolher a solução \textit{Offline}.