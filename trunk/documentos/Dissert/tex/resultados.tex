...
\begin{itemize}
	\item Três: Com três salas interligadas entre si (Figura \ref{fig:mapa_tres});
	...
	\item X Incompleto: Com cinco salas em formato de X com somente a sala do meio ligando as outras (Figura \ref{fig:mapa_x_incompletro});
	\item Espinha: Com seis salas em formato de espinha de peixe com prioridades iguais (Figura \ref{fig:mapa_espinha});
	\item Espinha Diff: Com seis salas em formato de espinha de peixa com prioridades diferentes (Figura \ref{fig:mapa_espinha}).
\end{itemize}

\begin{figure}[ht]
  \centering
	\subfigure[Três]{
    \includegraphics[width=0.217\textwidth]{../../imagens/mapa_tres.png}
		\label{fig:mapa_tres}}	
	\subfigure[Quatro]{
    \includegraphics[width=0.217\textwidth]{../../imagens/mapa_quatro.png}
		\label{fig:mapa_quatro}}	
	\subfigure[X]{
    \includegraphics[width=0.287\textwidth]{../../imagens/mapa_x.png}
		\label{fig:mapa_x}}	
	\subfigure[X incompleto]{
    \includegraphics[width=0.287\textwidth]{../../imagens/mapa_x_incompleto.png}
		\label{fig:mapa_x_incompleto}}	
	\subfigure[Espinha]{
    \includegraphics[width=0.311\textwidth]{../../imagens/mapa_espinha.png}
...
O \texttt{gerador} gerou as seqüências de salar para serem visitadas descritas da Tabela \ref{tab:sequencias}.
...
\begin{figure}[ht]
  \centering
	\subfigure[Três]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_tres.png}
		\label{fig:grafico_}}	
	\subfigure[Quatro]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_quatro.png}
		\label{fig:grafico_}}	
	\subfigure[Quatro Diff]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_quatro_diff.png}
		\label{fig:grafico_}}	
	\subfigure[X]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_x.png}
		\label{fig:grafico_}}	
	\subfigure[X Incompleto]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_x_incompleto.png}
		\label{fig:grafico_}}	
	\subfigure[Espinha]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_espinha.png}
		\label{fig:grafico_}}	
	\subfigure[Espinha Diff]{
    \includegraphics[width=0.2\textwidth]{../../imagens/grafico_espinha_diff.png}
		\label{fig:grafico_}}	
	\label{fig:graficos}}	
