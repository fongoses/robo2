...
\begin{figure}[h]
	...
	\caption{Exemplo de Funcionamento do LASER \cite{Baguinski}.}
	\label{fig:laser}
\end{figure}
...
\figura{../../imagens/stage.jpg}{.5}{Simulação com 5 robôs, 2 objetos, LASER, sonar e \textit{blobfinder} \cite{PennsylvaniaStateUniversityRobotics2010}.}{fig:stage}
