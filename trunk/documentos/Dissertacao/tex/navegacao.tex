...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.9\textwidth]{../../imagens/fluxo_navegacao.jpg}
	\caption{Hierarquia do controle de um robô móvel mostrando o fluxo de informação \cite{Mckerrow1991}.}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.4\textwidth]{../../imagens/exemplo_voronoi.jpg}
	\caption{Exemplo de um diagrama de Voronoi \cite{Siegwart2004}.}
	\label{fig:exemplo_voronoi}
\end{figure}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.5\textwidth]{../../imagens/decomposicao_celulas.jpg}
	\caption{Exemplo de um mapa com decomposição em células \cite{Siegwart2004}.}
	\label{fig:decomposicao_celulas}
\end{figure}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.7\textwidth]{../../imagens/campos_potenciais.jpg}
	\caption{Exemplo de um mapa com campos potenciais.\cite{Ottoni2000}}
	\label{fig:campos_potenciais}
\end{figure}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.8\textwidth]{../../imagens/histogram_grid.png}
	\caption{(a) Exemplo de um mapa. (b) Grade de histograma correspondente.\cite{Borenstein1991}}
	\label{fig:histogram_grid}
\end{figure}

\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.9\textwidth]{../../imagens/polar_histogram.png}
	\caption{(a) Densidade polar de obstáculo em um histograma polar relativo à posição do robô em $O$ (Figura \ref{fig:histogram_grid}(b)). (b) O mesmo histograma polar de (a) mostrado em forma polar e por cima da grade de histograma da Figura \ref{fig:histogram_grid}(b).\cite{Borenstein1991}}
