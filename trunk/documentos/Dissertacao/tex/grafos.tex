...
\begin{figure}[!htb]
	...
	\subfigure[Grafo direcionado]{
		\includegraphics[width=0.3\textwidth]{../../imagens/grafo_direcionado.jpg}
		\label{fig:grafo_dir}}
	\subfigure[Grafo não direcionado]{
		\includegraphics[width=0.3\textwidth]{../../imagens/grafo_nao_direcionado.jpg}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.3\textwidth]{../../imagens/dodecaedro_de_hamilton.jpg}
	\caption{Dodecaedro de Hamilton.\cite{Beineke1978}}
	\label{fig:dodecaedro_de_hamilton}
\end{figure}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.5\textwidth]{../../imagens/sub-rotas.jpg}
	\caption{Exemplo de possíveis sub-rotas.\cite{Arenales2007}}
	\label{fig:sub-rotas}
\end{figure}
